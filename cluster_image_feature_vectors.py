...
def cluster():
    ...
    allfiles = glob.glob('results/*.npz')
    ...
    for file_index, i in enumerate(allfiles):
        ...
        file_index_to_product_id[file_index] = file_name #match_id(file_name)
    ...
    for i in file_index_to_file_name.keys():
        ...
        for j in nearest_neighbors:
            ...
            # and filter de image that want to be search similarities
            if master_product_id == image_similarity_search and neighbor_product_id != image_similarity_search:
