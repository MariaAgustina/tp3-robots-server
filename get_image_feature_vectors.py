...
# Loops through all images in a local folder
 #for filename in '/uploaded-images/*.jpg':

 for filename in os.listdir('uploaded-images/'):
   if filename.endswith(".jpg") or filename.endswith(".png"):

    print(filename)
  # Loads and pre-process the image
    filePath = 'uploaded-images/{}'.format(filename)
  ...
  # Remove single-dimensional entries from the 'features' array
    ...
    out_path = os.path.join('results/',outfile_name)
